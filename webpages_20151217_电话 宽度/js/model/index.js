        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var firstLi =
                    ...
                    '<span class="font-c-40">' + data[data.length-1].address + ' | 约1.5km</span>' +
                    '</p>' +
                    '<p>' +
                ...
                var lastLi =
                    ...
                    '<p>' +
                    '<span class="font-c-8f">地址 ：</span>' +
                    '<span class="font-c-40">' + data[0].address + ' | 约1.5km</span>' +
                    '</p>' +
                    '<p>' +
                    '<span class="font-c-8f">电话 ：</span>' +
                    '<span class="font-c-40"><a class="font-c-40" href="tel:010-52190227">010-52190227</a></span>' +
                ...
                for (var i = 0; i < data.length; i++) {
                    if(i==0)
                    {
                        ...
                        var restaurantInfo =
                            ...
                            '<p>'+
                            '<span class="font-c-8f">地址 ：</span>'+
                            '<span class="font-c-40">'+data[i].address+' | 约1.5km</span>'+
                            '</p>'+
                            '<p>'+
                            '<span class="font-c-8f">电话 ：</span>'+
                            '<span class="font-c-40"><a class="font-c-40" href="tel:010-52190227">010-52190227</a></span>'+
