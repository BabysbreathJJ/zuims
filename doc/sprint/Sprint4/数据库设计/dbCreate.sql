...
CREATE TABLE IF NOT EXISTS `mydb`.`Hotel` (
  ...
  `ContractStat` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`HotelID`))
ENGINE = InnoDB;
...
Begin
	...
	(City, HotelName, HotelTele, HotelAddress, Location, Memo)
	VALUES
...
Begin
	...
	(City, RestaurantName, RestaurantTele, RestaurantAddress, RestaurantOpenTime, Introduction, AveragePrice, Park, Smoke, Location, Memo)
	VALUES
